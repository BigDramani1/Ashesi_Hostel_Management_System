...
<?php if (empty($customer_id)) { ?>
    ...
    <section class="featured portfolio bg-white-2 rec-pro full-l">
        <div class="container-fluid">
            ...
            <div class="row portfolio-items">
                <?php
                $products = select_6_hostels_controller();
    ...
    <div class=\"project-single\" data-aos=\"fade-up\">
        <div class=\"project-inner project-head\">
            ...
            <input type='hidden' name='room_id' value='{$bag['hostel_id']}'>
                <h4><a href=\"hostel_details.php?id={$bag['hostel_id']}\">View Property</a></h4>
            </div>
            <div class=\"homes\">
                <a href=\"hostel_details.php?id={$bag['hostel_id']}\" class=\"homes-img\">
                    <img src=\"{$bag['image']}\" alt=\"home-1\" class=\"img-responsive\">
                </a>
            </div>
            <div class=\"button-effect\">
                <a href=\"hostel_details.php?id={$bag['hostel_id']}\" class=\"img-poppu btn\"><i class=\"fa fa-photo\"></i></a>
            </div>
        </div>
        <div class=\"homes-content\">
            <h3><a href=\"hostel_details.php?id={$bag['hostel_id']}\">{$bag['hostel_name']}</a></h3>
            <p class=\"homes-address mb-3\">
                <a href=\"hostel_details.php?id={$bag['hostel_id']}\">
            ...
            <div class=\"price-properties footer pt-3 pb-0\">
                <h3 class=\"title mt-3\">
                 <a href=\"hostel_details.php?id={$bag['hostel_id']}\">GH₵ {$bag['price_range']}</a>
                </h3>
            </div>
        </div>
    </div>
            ...
            <div class="bg-all">
                <a href="all_hostels.php" class="btn btn-outline-light">View More</a>
            </div>
        </div>
    </section>
    ...
    <script>
        var typed = new Typed('.typed', {
            strings: ["Hostel ^10000", "Home ^4000"],
