                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" style="border-radius:10px; height:auto;"class="form-control" placeholder="Search here.....">&nbsp;
            ...
            <div class="container-fluid">
                ...
                <?php require_once ("components/index_components.php");?>
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            index($row['hostel_id'], $row['hostel_name'], $row['price_range'],$row['image']);
                        }  
                        ?>          
                </div>
                <div class="bg-all">
