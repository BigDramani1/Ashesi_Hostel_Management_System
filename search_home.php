        ...
        <header id="header-container" class="header head-tr">
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    <div class="left-side">
                        <div id="logo">
                            <a href="home.php"><img src="images/Home.png" data-sticky-logo="images/rest.png" alt=""></a>
                        </div>
                        <!-- Mobile Navigation -->
        ...
        <section class="featured portfolio bg-white-2 rec-pro full-l">
            <div class="container-fluid">
                       ...
                       if(isset($_GET['search']))
               {
                   ...
                   $query = "SELECT * FROM hostels WHERE CONCAT(hostel_name, hostel_owner, price_range) LIKE '%$filtervalues%' ";
                   ...
                   if(mysqli_num_rows($query_run) > 0)
                   {
                       foreach($query_run as $items)
                       {
                        ...
                        <h4><a href=\"{$items['direction']}\">View Property</a></h4>
                        </div>
                        <div class=\"homes\">
                        <a href=\"{$items['direction']}\" class=\"homes-img\">
                        <img src=\"{$items['image']}\" alt=\"home-1\" class=\"img-responsive\">
                        </a>
                        </div>
                        <div class=\"button-effect\">
                        <a href=\"{$items['direction']}\" class=\"img-poppu btn\"><i class=\"fa fa-photo\"></i></a>
                        </div>
                        </div>
                        <div class=\"homes-content\">
                        <h3><a href=\"{$items['direction']}\">{$items['hostel_name']}</a></h3>
                        ...
                        <h3 class=\"title mt-3\">
                        <a href=\"{$items['direction']}\">GH₵ {$items['price_range']}</a>
                        </h3>
                        </div>
                        </div>
                        </div>
